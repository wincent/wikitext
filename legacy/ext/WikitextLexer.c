...
//   Comes from: 93:19: ( ( HTTP | FTP | SVN ) URI_CHARS ( ( SPECIAL_URI_CHARS URI_CHARS )=> ( SPECIAL_URI_CHARS URI_CHARS ) )* )
/** \brief Lexer rule generated by ANTLR3
 *
 * $ANTLR start URI
 *
...
void mURI(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:93:19: ( ( HTTP | FTP | SVN ) URI_CHARS ( ( SPECIAL_URI_CHARS URI_CHARS )=> ( SPECIAL_URI_CHARS URI_CHARS ) )* )
    // Wikitext.g:93:21: ( HTTP | FTP | SVN ) URI_CHARS ( ( SPECIAL_URI_CHARS URI_CHARS )=> ( SPECIAL_URI_CHARS URI_CHARS ) )*
    {

        // Wikitext.g:93:21: ( HTTP | FTP | SVN )
        {
            int alt14=3;
            switch ( LA(1) ) 
            {
            ...
            default:
                ...
                EXCEPTION->message      = "93:21: ( HTTP | FTP | SVN )";
        ...
        /* 93:21: ( HTTP | FTP | SVN ) URI_CHARS ( ( SPECIAL_URI_CHARS URI_CHARS )=> ( SPECIAL_URI_CHARS URI_CHARS ) )* */
        mURI_CHARS(ctx ); 
        if (HASFAILED())
        {
            return ;
        ...
        // Wikitext.g:93:50: ( ( SPECIAL_URI_CHARS URI_CHARS )=> ( SPECIAL_URI_CHARS URI_CHARS ) )*
        ...
        for (;;)
        {
            ...
            {
        	case 1:
        	    // Wikitext.g:93:51: ( SPECIAL_URI_CHARS URI_CHARS )=> ( SPECIAL_URI_CHARS URI_CHARS )
        	    {
        	        // Wikitext.g:93:83: ( SPECIAL_URI_CHARS URI_CHARS )
        	        // Wikitext.g:93:84: SPECIAL_URI_CHARS URI_CHARS
        	        {
        	            /* 93:84: SPECIAL_URI_CHARS URI_CHARS */
...
//   Comes from: 96:19: ( ( 'h' | 'H' ) ( 't' | 'T' ) ( 't' | 'T' ) ( 'p' | 'P' ) ( 's' | 'S' )? '://' )
/** \brief Lexer rule generated by ANTLR3
 *
 * $ANTLR start HTTP
 *
...
void mHTTP(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:96:19: ( ( 'h' | 'H' ) ( 't' | 'T' ) ( 't' | 'T' ) ( 'p' | 'P' ) ( 's' | 'S' )? '://' )
    // Wikitext.g:96:21: ( 'h' | 'H' ) ( 't' | 'T' ) ( 't' | 'T' ) ( 'p' | 'P' ) ( 's' | 'S' )? '://'
    {
        if ( LA(1) == 'H' || LA(1) == 'h' )
        {
            CONSUME();
...
void mFTP(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:99:19: ( ( 'f' | 'F' ) ( 't' | 'T' ) ( 'p' | 'P' ) '://' )
    // Wikitext.g:99:21: ( 'f' | 'F' ) ( 't' | 'T' ) ( 'p' | 'P' ) '://'
    {
        if ( LA(1) == 'F' || LA(1) == 'f' )
        {
            CONSUME();
...
void mSVN(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:102:19: ( ( 's' | 'S' ) ( 'v' | 'V' ) ( 'n' | 'N' ) '://' )
    // Wikitext.g:102:21: ( 's' | 'S' ) ( 'v' | 'V' ) ( 'n' | 'N' ) '://'
    {
        if ( LA(1) == 'S' || LA(1) == 's' )
        {
            CONSUME();
...
//   Comes from: 105:19: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '@' | '$' | '&' | '\\'' | '(' | '*' | '+' | '=' | '\\%' | '-' | '_' | '~' | '/' | '#' )+ )
/** \brief Lexer rule generated by ANTLR3
 *
...
void mURI_CHARS(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:105:19: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '@' | '$' | '&' | '\\'' | '(' | '*' | '+' | '=' | '\\%' | '-' | '_' | '~' | '/' | '#' )+ )
    // Wikitext.g:105:21: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '@' | '$' | '&' | '\\'' | '(' | '*' | '+' | '=' | '\\%' | '-' | '_' | '~' | '/' | '#' )+
    {
        // Wikitext.g:105:21: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '@' | '$' | '&' | '\\'' | '(' | '*' | '+' | '=' | '\\%' | '-' | '_' | '~' | '/' | '#' )+
        {
            int cnt17=0;
...
void mNAMED_ENTITY(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:133:17: ( '&' ( 'a' .. 'z' | 'A' .. 'Z' )+ ( '0' .. '9' )* ';' )
    // Wikitext.g:133:20: '&' ( 'a' .. 'z' | 'A' .. 'Z' )+ ( '0' .. '9' )* ';'
    {
        MATCHC('&'); 
        if (HASFAILED())
        {
...
//   Comes from: 141:17: ( '&#' ( 'x' | 'X' ) ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+ ';' )
/** \brief Lexer rule generated by ANTLR3
 *
...
void mHEX_ENTITY(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:141:17: ( '&#' ( 'x' | 'X' ) ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+ ';' )
    // Wikitext.g:141:19: '&#' ( 'x' | 'X' ) ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+ ';'
    {
        MATCHS(lit_12); 
        if (HASFAILED())
        {
...
void mDECIMAL_ENTITY(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:143:17: ( '&#' ( '0' .. '9' )+ ';' )
    // Wikitext.g:143:19: '&#' ( '0' .. '9' )+ ';'
    {
        MATCHS(lit_12); 
        if (HASFAILED())
        {
    ...
    
    {
...

        {
            ...
            else 
            {
                ...
                CONSTRUCTEX();
                EXCEPTION->type         = ANTLR3_NO_VIABLE_ALT_EXCEPTION;
                EXCEPTION->message      = "159:1: CRLF : ( ( ( '\\r' )? '\\n' )=> ( '\\r' )? '\\n' | '\\r' );";
...
void mPRINTABLE(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:166:17: ( '\\u0021' | '\\u0023' .. '\\u0025' | '\\u0027' .. '\\u003B' | '\\u003D' | '\\u003F' .. '\\u005a' | '\\u005C' | '\\u005E' .. '\\u005F' | '\\u0061' .. '\\u007B' | '\\u007E' )
    // Wikitext.g:
    {
        if ( LA(1) == '!' || ((LA(1) >= '#') && (LA(1) <= '%')) || ((LA(1) >= '\'') && (LA(1) <= ';')) || LA(1) == '=' || ((LA(1) >= '?') && (LA(1) <= 'Z')) || LA(1) == '\\' || ((LA(1) >= '^') && (LA(1) <= '_')) || ((LA(1) >= 'a') && (LA(1) <= '{')) || LA(1) == '~' )
        {
            CONSUME();
        FAILEDFLAG=ANTLR3_FALSE;
...
{
    {
        //  Wikitext.g:1:39: ( PRE | NO_WIKI_START | NO_WIKI_END | BLOCKQUOTE | STRONG_EM | STRONG | EM | TT_START | TT_END | TT | OL | UL | H6_START | H5_START | H4_START | H3_START | H2_START | H1_START | H6_END | H5_END | H4_END | H3_END | H2_END | H1_END | URI | LINK_START | LINK_END | EXT_LINK_START | EXT_LINK_END | SEPARATOR | SPACE | QUOT_ENTITY | AMP_ENTITY | NAMED_ENTITY | HEX_ENTITY | DECIMAL_ENTITY | QUOT | AMP | LESS | GREATER | CRLF | PRINTABLE | DEFAULT )
...

        {
            ...
            if ( (LA25_0 == ' ') ) 
            {

                {
                    ...
                    else 
                    {
                        ...
                        CONSTRUCTEX();
                        EXCEPTION->type         = ANTLR3_NO_VIABLE_ALT_EXCEPTION;
                        EXCEPTION->message      = "1:1: Tokens options {k=1; backtrack=true; } : ( PRE | NO_WIKI_START | NO_WIKI_END | BLOCKQUOTE | STRONG_EM | STRONG | EM | TT_START | TT_END | TT | OL | UL | H6_START | H5_START | H4_START | H3_START | H2_START | H1_START | H6_END | H5_END | H4_END | H3_END | H2_END | H1_END | URI | LINK_START | LINK_END | EXT_LINK_START | EXT_LINK_END | SEPARATOR | SPACE | QUOT_ENTITY | AMP_ENTITY | NAMED_ENTITY | HEX_ENTITY | DECIMAL_ENTITY | QUOT | AMP | LESS | GREATER | CRLF | PRINTABLE | DEFAULT );";
            ...
            else if ( (LA25_0 == '#') ) 
            {
                ...
                {
                    int LA25_6 = LA(2);
                    if ( (( (synpred13(ctx)) && ( COLUMN == 0 || LAST_TOKEN == OL || LAST_TOKEN == UL || LAST_TOKEN == BLOCKQUOTE ) )) ) 
                    {
                        alt25=11;
                    }
                    else if ( (synpred44(ctx)) ) 
            ...
            else if ( (LA25_0 == '*') ) 
            {
                ...
                {
                    int LA25_7 = LA(2);
                    if ( (( (synpred14(ctx)) && ( COLUMN == 0 || LAST_TOKEN == UL || LAST_TOKEN == OL || LAST_TOKEN == BLOCKQUOTE ) )) ) 
                    {
                        alt25=12;
                    }
                    else if ( (synpred44(ctx)) ) 
            ...
            else if ( (LA25_0 == '=') ) 
            {
                ...
                {
                    int LA25_8 = LA(2);
                    if ( (( (synpred15(ctx)) && ( COLUMN == 0 || LAST_TOKEN == BLOCKQUOTE ) )) ) 
                    {
                        alt25=13;
                    }
    	...
    	case 27:
    	    ...
    	    break;
    	case 28:
    	    // Wikitext.g:1:247: EXT_LINK_START
    	    {
    	        /* 1:247: EXT_LINK_START */
    	        mEXT_LINK_START(ctx ); 
    	        if (HASFAILED())
    	        {
    	            return ;
    	...
    	case 35:
    	    ...
    	    break;
    	case 36:
    	    // Wikitext.g:1:338: DECIMAL_ENTITY
    	    {
    	        /* 1:338: DECIMAL_ENTITY */
    	        mDECIMAL_ENTITY(ctx ); 
    	        if (HASFAILED())
    	        {
    	            return ;
...
{   
    // Wikitext.g:93:51: ( SPECIAL_URI_CHARS URI_CHARS )
    // Wikitext.g:93:52: SPECIAL_URI_CHARS URI_CHARS
    {
        /* 93:52: SPECIAL_URI_CHARS URI_CHARS */
        mSPECIAL_URI_CHARS(ctx ); 
        if (HASFAILED())
        {
            return ;
