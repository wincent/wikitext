...
void mNAMED_ENTITY(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:116:17: ( '&' ( 'a' .. 'z' | 'A' .. 'Z' )+ ( '0' .. '9' )* ';' )
    // Wikitext.g:116:20: '&' ( 'a' .. 'z' | 'A' .. 'Z' )+ ( '0' .. '9' )* ';'
    {
        MATCHC('&'); 
        if (HASFAILED())
        {
...
//   Comes from: 124:17: ( '&#' ( 'x' | 'X' ) ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+ ';' )
/** \brief Lexer rule generated by ANTLR3
 *
...
void mHEX_ENTITY(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:124:17: ( '&#' ( 'x' | 'X' ) ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+ ';' )
    // Wikitext.g:124:19: '&#' ( 'x' | 'X' ) ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+ ';'
    {
        MATCHS(lit_10); 
        if (HASFAILED())
        {
...
void mDECIMAL_ENTITY(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:126:17: ( '&#' ( '0' .. '9' )+ ';' )
    // Wikitext.g:126:19: '&#' ( '0' .. '9' )+ ';'
    {
        MATCHS(lit_10); 
        if (HASFAILED())
        {
    ...
    
    {
...

        {
            ...
            else 
            {
                ...
                CONSTRUCTEX();
                EXCEPTION->type         = ANTLR3_NO_VIABLE_ALT_EXCEPTION;
                EXCEPTION->message      = "142:1: CRLF : ( ( ( '\\r' )? '\\n' )=> ( '\\r' )? '\\n' | '\\r' );";
