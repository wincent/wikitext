...
//   Comes from: 89:19: ( ( HTTP | FTP | SVN ) URI_CHARS ( ( SPECIAL_URI_CHARS URI_CHARS )=> ( SPECIAL_URI_CHARS URI_CHARS ) )* )
/** \brief Lexer rule generated by ANTLR3
 *
 * $ANTLR start URI
 *
...
void mURI(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:89:19: ( ( HTTP | FTP | SVN ) URI_CHARS ( ( SPECIAL_URI_CHARS URI_CHARS )=> ( SPECIAL_URI_CHARS URI_CHARS ) )* )
    // Wikitext.g:89:21: ( HTTP | FTP | SVN ) URI_CHARS ( ( SPECIAL_URI_CHARS URI_CHARS )=> ( SPECIAL_URI_CHARS URI_CHARS ) )*
    {

        // Wikitext.g:89:21: ( HTTP | FTP | SVN )
        {
            int alt14=3;
            switch ( LA(1) ) 
            {
            ...
            default:
                ...
                EXCEPTION->message      = "89:21: ( HTTP | FTP | SVN )";
        ...
        /* 89:21: ( HTTP | FTP | SVN ) URI_CHARS ( ( SPECIAL_URI_CHARS URI_CHARS )=> ( SPECIAL_URI_CHARS URI_CHARS ) )* */
        mURI_CHARS(ctx ); 
        if (HASFAILED())
        {
            return ;
        ...
        // Wikitext.g:89:50: ( ( SPECIAL_URI_CHARS URI_CHARS )=> ( SPECIAL_URI_CHARS URI_CHARS ) )*
        ...
        for (;;)
        {
            ...
            {
        	case 1:
        	    // Wikitext.g:89:51: ( SPECIAL_URI_CHARS URI_CHARS )=> ( SPECIAL_URI_CHARS URI_CHARS )
        	    {
        	        // Wikitext.g:89:83: ( SPECIAL_URI_CHARS URI_CHARS )
        	        // Wikitext.g:89:84: SPECIAL_URI_CHARS URI_CHARS
        	        {
        	            /* 89:84: SPECIAL_URI_CHARS URI_CHARS */
...
//   Comes from: 92:19: ( ( 'h' | 'H' ) ( 't' | 'T' ) ( 't' | 'T' ) ( 'p' | 'P' ) ( 's' | 'S' )? '://' )
/** \brief Lexer rule generated by ANTLR3
 *
 * $ANTLR start HTTP
 *
...
void mHTTP(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:92:19: ( ( 'h' | 'H' ) ( 't' | 'T' ) ( 't' | 'T' ) ( 'p' | 'P' ) ( 's' | 'S' )? '://' )
    // Wikitext.g:92:21: ( 'h' | 'H' ) ( 't' | 'T' ) ( 't' | 'T' ) ( 'p' | 'P' ) ( 's' | 'S' )? '://'
    {
        if ( LA(1) == 'H' || LA(1) == 'h' )
        {
            CONSUME();
...
void mFTP(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:95:19: ( ( 'f' | 'F' ) ( 't' | 'T' ) ( 'p' | 'P' ) '://' )
    // Wikitext.g:95:21: ( 'f' | 'F' ) ( 't' | 'T' ) ( 'p' | 'P' ) '://'
    {
        if ( LA(1) == 'F' || LA(1) == 'f' )
        {
            CONSUME();
...
void mSVN(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:98:19: ( ( 's' | 'S' ) ( 'v' | 'V' ) ( 'n' | 'N' ) '://' )
    // Wikitext.g:98:21: ( 's' | 'S' ) ( 'v' | 'V' ) ( 'n' | 'N' ) '://'
    {
        if ( LA(1) == 'S' || LA(1) == 's' )
        {
            CONSUME();
...
//   Comes from: 101:19: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '@' | '$' | '&' | '\\'' | '(' | '*' | '+' | '=' | '\\%' | '-' | '_' | '~' | '/' | '#' )+ )
/** \brief Lexer rule generated by ANTLR3
 *
...
void mURI_CHARS(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:101:19: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '@' | '$' | '&' | '\\'' | '(' | '*' | '+' | '=' | '\\%' | '-' | '_' | '~' | '/' | '#' )+ )
    // Wikitext.g:101:21: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '@' | '$' | '&' | '\\'' | '(' | '*' | '+' | '=' | '\\%' | '-' | '_' | '~' | '/' | '#' )+
    {
        // Wikitext.g:101:21: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '@' | '$' | '&' | '\\'' | '(' | '*' | '+' | '=' | '\\%' | '-' | '_' | '~' | '/' | '#' )+
        {
            int cnt17=0;
...
void mNAMED_ENTITY(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:125:17: ( '&' ( 'a' .. 'z' | 'A' .. 'Z' )+ ( '0' .. '9' )* ';' )
    // Wikitext.g:125:20: '&' ( 'a' .. 'z' | 'A' .. 'Z' )+ ( '0' .. '9' )* ';'
    {
        MATCHC('&'); 
        if (HASFAILED())
        {
...
//   Comes from: 133:17: ( '&#' ( 'x' | 'X' ) ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+ ';' )
/** \brief Lexer rule generated by ANTLR3
 *
...
void mHEX_ENTITY(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:133:17: ( '&#' ( 'x' | 'X' ) ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+ ';' )
    // Wikitext.g:133:19: '&#' ( 'x' | 'X' ) ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+ ';'
    {
        MATCHS(lit_10); 
        if (HASFAILED())
        {
...
void mDECIMAL_ENTITY(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:135:17: ( '&#' ( '0' .. '9' )+ ';' )
    // Wikitext.g:135:19: '&#' ( '0' .. '9' )+ ';'
    {
        MATCHS(lit_10); 
        if (HASFAILED())
        {
    ...
    
    {
...

        {
            ...
            else 
            {
                ...
                CONSTRUCTEX();
                EXCEPTION->type         = ANTLR3_NO_VIABLE_ALT_EXCEPTION;
                EXCEPTION->message      = "151:1: CRLF : ( ( ( '\\r' )? '\\n' )=> ( '\\r' )? '\\n' | '\\r' );";
...
{   
    // Wikitext.g:89:51: ( SPECIAL_URI_CHARS URI_CHARS )
    // Wikitext.g:89:52: SPECIAL_URI_CHARS URI_CHARS
    {
        /* 89:52: SPECIAL_URI_CHARS URI_CHARS */
        mSPECIAL_URI_CHARS(ctx ); 
        if (HASFAILED())
        {
            return ;
