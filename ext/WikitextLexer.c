...
static ANTLR3_UCHAR	lit_10[]  = { 0x26, 0x23,  ANTLR3_STRING_TERMINATOR};
...
void mNAMED_ENTITY(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:126:17: ( '&' ( 'a' .. 'z' | 'A' .. 'Z' )+ ( '0' .. '9' )* ';' )
    // Wikitext.g:126:20: '&' ( 'a' .. 'z' | 'A' .. 'Z' )+ ( '0' .. '9' )* ';'
    {
        MATCHC('&'); 
        if (HASFAILED())
        {
...
//   Comes from: 134:17: ( '&#' ( 'x' | 'X' ) ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+ ';' )
/** \brief Lexer rule generated by ANTLR3
 *
...
void mHEX_ENTITY(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:134:17: ( '&#' ( 'x' | 'X' ) ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+ ';' )
    // Wikitext.g:134:19: '&#' ( 'x' | 'X' ) ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+ ';'
    {
        MATCHS(lit_10); 
        if (HASFAILED())
        {
...
void mDECIMAL_ENTITY(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:136:17: ( '&#' ( '0' .. '9' )+ ';' )
    // Wikitext.g:136:19: '&#' ( '0' .. '9' )+ ';'
    {
        MATCHS(lit_10); 
        if (HASFAILED())
        {
    ...
    
    {
...

        {
            ...
            else 
            {
                ...
                CONSTRUCTEX();
                EXCEPTION->type         = ANTLR3_NO_VIABLE_ALT_EXCEPTION;
                EXCEPTION->message      = "152:1: CRLF : ( ( ( '\\r' )? '\\n' )=> ( '\\r' )? '\\n' | '\\r' );";
...
{
    {
        //  Wikitext.g:1:39: ( PRE | NO_WIKI_START | NO_WIKI_END | BLOCKQUOTE | STRONG_EM | STRONG | EM | TT_START | TT_END | OL | UL | H6_START | H5_START | H4_START | H3_START | H2_START | H1_START | H6_END | H5_END | H4_END | H3_END | H2_END | H1_END | URI | LINK_START | LINK_END | EXT_LINK_START | EXT_LINK_END | SEPARATOR | SPACE | NAMED_ENTITY | HEX_ENTITY | DECIMAL_ENTITY | QUOT | AMP | LESS | GREATER | CRLF | PRINTABLE | DEFAULT )
            ...
            if ( (LA25_0 == ' ') ) 
            {

                {
                    ...
                    else 
                    {
                        ...
                        CONSTRUCTEX();
                        EXCEPTION->type         = ANTLR3_NO_VIABLE_ALT_EXCEPTION;
                        EXCEPTION->message      = "1:1: Tokens options {k=1; backtrack=true; } : ( PRE | NO_WIKI_START | NO_WIKI_END | BLOCKQUOTE | STRONG_EM | STRONG | EM | TT_START | TT_END | OL | UL | H6_START | H5_START | H4_START | H3_START | H2_START | H1_START | H6_END | H5_END | H4_END | H3_END | H2_END | H1_END | URI | LINK_START | LINK_END | EXT_LINK_START | EXT_LINK_END | SEPARATOR | SPACE | NAMED_ENTITY | HEX_ENTITY | DECIMAL_ENTITY | QUOT | AMP | LESS | GREATER | CRLF | PRINTABLE | DEFAULT );";
    	...
    	case 32:
    	    ...
    	    break;
    	case 33:
    	    // Wikitext.g:1:312: DECIMAL_ENTITY
    	    {
    	        /* 1:312: DECIMAL_ENTITY */
    	        mDECIMAL_ENTITY(ctx ); 
    	        if (HASFAILED())
    	        {
    	            return ;
