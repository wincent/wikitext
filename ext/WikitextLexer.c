...
//   Comes from: 115:17: ( NAMED_ENTITY | HEX_ENTITY | DECIMAL_ENTITY )
/** \brief Lexer rule generated by ANTLR3
 *
 * $ANTLR start ENTITY
 *
...
void mENTITY(pWikitextLexer ctx)
{
    ...
    {
        //  Wikitext.g:115:17: ( NAMED_ENTITY | HEX_ENTITY | DECIMAL_ENTITY )
                    ...
                    if ( (LA19_1 == '#') ) 
                    {

                        {
                            ...
                            else 
                            {
                                ...
                                CONSTRUCTEX();
                                EXCEPTION->type         = ANTLR3_NO_VIABLE_ALT_EXCEPTION;
                                EXCEPTION->message      = "115:1: ENTITY : ( NAMED_ENTITY | HEX_ENTITY | DECIMAL_ENTITY );";
        ...
        {
    	case 1:
    	    // Wikitext.g:115:19: NAMED_ENTITY
    	    {
    	        /* 115:19: NAMED_ENTITY */
    	        mNAMED_ENTITY(ctx ); 
    	        if (HASFAILED())
    	...
    	case 2:
    	    ...
    	    break;
    	case 3:
    	    // Wikitext.g:115:47: DECIMAL_ENTITY
    	    {
    	        /* 115:47: DECIMAL_ENTITY */
    	        mDECIMAL_ENTITY(ctx ); 
    	        if (HASFAILED())
    	        {
    	            return ;
...
void mNAMED_ENTITY(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:119:17: ( '&' ( 'a' .. 'z' | 'A' .. 'Z' )+ ( '0' .. '9' )* ';' )
    // Wikitext.g:119:20: '&' ( 'a' .. 'z' | 'A' .. 'Z' )+ ( '0' .. '9' )* ';'
    {
        MATCHC('&'); 
        if (HASFAILED())
        {
...
//   Comes from: 128:17: ( '&#' ( 'x' | 'X' ) ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+ ';' )
/** \brief Lexer rule generated by ANTLR3
 *
...
void mHEX_ENTITY(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:128:17: ( '&#' ( 'x' | 'X' ) ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+ ';' )
    // Wikitext.g:128:19: '&#' ( 'x' | 'X' ) ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+ ';'
    {
        MATCHS(lit_10); 
        if (HASFAILED())
        {
...
void mDECIMAL_ENTITY(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:131:17: ( '&#' ( '0' .. '9' )+ ';' )
    // Wikitext.g:131:19: '&#' ( '0' .. '9' )+ ';'
    {
        MATCHS(lit_10); 
        if (HASFAILED())
        {
    ...
    
    {
...

        {
            ...
            else 
            {
                ...
                CONSTRUCTEX();
                EXCEPTION->type         = ANTLR3_NO_VIABLE_ALT_EXCEPTION;
                EXCEPTION->message      = "147:1: CRLF : ( ( ( '\\r' )? '\\n' )=> ( '\\r' )? '\\n' | '\\r' );";
