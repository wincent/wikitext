...
static ANTLR3_UCHAR	lit_2[]  = { 0x60, 0x60,  ANTLR3_STRING_TERMINATOR};
static ANTLR3_UCHAR	lit_3[]  = { 0x3D, 0x3D, 0x3D, 0x3D, 0x3D, 0x3D,  ANTLR3_STRING_TERMINATOR};
static ANTLR3_UCHAR	lit_4[]  = { 0x3D, 0x3D, 0x3D, 0x3D, 0x3D,  ANTLR3_STRING_TERMINATOR};
static ANTLR3_UCHAR	lit_5[]  = { 0x3D, 0x3D, 0x3D, 0x3D,  ANTLR3_STRING_TERMINATOR};
static ANTLR3_UCHAR	lit_6[]  = { 0x3D, 0x3D, 0x3D,  ANTLR3_STRING_TERMINATOR};
static ANTLR3_UCHAR	lit_7[]  = { 0x3D, 0x3D,  ANTLR3_STRING_TERMINATOR};
static ANTLR3_UCHAR	lit_8[]  = { 0x3A, 0x2F, 0x2F,  ANTLR3_STRING_TERMINATOR};
static ANTLR3_UCHAR	lit_9[]  = { 0x5B, 0x5B,  ANTLR3_STRING_TERMINATOR};
static ANTLR3_UCHAR	lit_10[]  = { 0x5D, 0x5D,  ANTLR3_STRING_TERMINATOR};
static ANTLR3_UCHAR	lit_11[]  = { 0x26, 0x71, 0x75, 0x6F, 0x74, 0x3B,  ANTLR3_STRING_TERMINATOR};
static ANTLR3_UCHAR	lit_12[]  = { 0x26, 0x61, 0x6D, 0x70, 0x3B,  ANTLR3_STRING_TERMINATOR};
static ANTLR3_UCHAR	lit_13[]  = { 0x26, 0x23,  ANTLR3_STRING_TERMINATOR};
...
static ANTLR3_INLINE void	mESCAPED_TT    (pWikitextLexer ctx);
static ANTLR3_INLINE void	mTT    (pWikitextLexer ctx);
...
static ANTLR3_INLINE ANTLR3_BOOLEAN	synpred44    (pWikitextLexer ctx);
static ANTLR3_INLINE ANTLR3_BOOLEAN	synpred45    (pWikitextLexer ctx);
...
ANTLR3_API pWikitextLexer WikitextLexerNew         (pANTLR3_INPUT_STREAM     instream)
{
    ...
    lexCtx->mESCAPED_TT	= mESCAPED_TT;
    lexCtx->mTT	= mTT;
    lexCtx->mOL	= mOL;
    lexCtx->mUL	= mUL;
    lexCtx->mH6	= mH6;
...
void mTT_START(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:55:17: ( '<' ( 't' | 'T' ) ( 't' | 'T' ) '>' )
    // Wikitext.g:55:19: '<' ( 't' | 'T' ) ( 't' | 'T' ) '>'
    {
        MATCHC('<'); 
        if (HASFAILED())
        {
...
/** \brief Lexer rule generated by ANTLR3
 *
 * $ANTLR start ESCAPED_TT
 *
 * Looks to match the characters the constitute the token ESCAPED_TT
 * from the attached input stream.
 *
 *
 * \remark
 ...
 */
static ANTLR3_INLINE
void mESCAPED_TT(pWikitextLexer ctx)
{
	ANTLR3_UINT32	_type;
    ...
    // This is where rules clean up and exit
    //
    goto ruleESCAPED_TTEx; /* Prevent compiler warnings */
    ruleESCAPED_TTEx: ;

}
// $ANTLR end ESCAPED_TT
 ...
 * $ANTLR start TT
 *
 * Looks to match the characters the constitute the token TT
 * from the attached input stream.
 *
 *
 * \remark
...
void mTT(pWikitextLexer ctx)
{
    ...
    // This is where rules clean up and exit
    //
    goto ruleTTEx; /* Prevent compiler warnings */
    ruleTTEx: ;
...
//   Comes from: 94:19: ( ( HTTP | FTP | SVN ) URI_CHARS ( ( SPECIAL_URI_CHARS URI_CHARS )=> ( SPECIAL_URI_CHARS URI_CHARS ) )* )
/** \brief Lexer rule generated by ANTLR3
 *
 * $ANTLR start URI
 *
...
void mURI(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:94:19: ( ( HTTP | FTP | SVN ) URI_CHARS ( ( SPECIAL_URI_CHARS URI_CHARS )=> ( SPECIAL_URI_CHARS URI_CHARS ) )* )
    // Wikitext.g:94:21: ( HTTP | FTP | SVN ) URI_CHARS ( ( SPECIAL_URI_CHARS URI_CHARS )=> ( SPECIAL_URI_CHARS URI_CHARS ) )*
    {

        // Wikitext.g:94:21: ( HTTP | FTP | SVN )
        {
            int alt14=3;
            switch ( LA(1) ) 
            {
            ...
            default:
                ...
                EXCEPTION->message      = "94:21: ( HTTP | FTP | SVN )";
        ...
        /* 94:21: ( HTTP | FTP | SVN ) URI_CHARS ( ( SPECIAL_URI_CHARS URI_CHARS )=> ( SPECIAL_URI_CHARS URI_CHARS ) )* */
        mURI_CHARS(ctx ); 
        if (HASFAILED())
        {
            return ;
        ...
        // Wikitext.g:94:50: ( ( SPECIAL_URI_CHARS URI_CHARS )=> ( SPECIAL_URI_CHARS URI_CHARS ) )*
        ...
        for (;;)
        {
            ...
            {
        	case 1:
        	    // Wikitext.g:94:51: ( SPECIAL_URI_CHARS URI_CHARS )=> ( SPECIAL_URI_CHARS URI_CHARS )
        	    {
        	        // Wikitext.g:94:83: ( SPECIAL_URI_CHARS URI_CHARS )
        	        // Wikitext.g:94:84: SPECIAL_URI_CHARS URI_CHARS
        	        {
        	            /* 94:84: SPECIAL_URI_CHARS URI_CHARS */
...
//   Comes from: 97:19: ( ( 'h' | 'H' ) ( 't' | 'T' ) ( 't' | 'T' ) ( 'p' | 'P' ) ( 's' | 'S' )? '://' )
/** \brief Lexer rule generated by ANTLR3
 *
 * $ANTLR start HTTP
 *
...
void mHTTP(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:97:19: ( ( 'h' | 'H' ) ( 't' | 'T' ) ( 't' | 'T' ) ( 'p' | 'P' ) ( 's' | 'S' )? '://' )
    // Wikitext.g:97:21: ( 'h' | 'H' ) ( 't' | 'T' ) ( 't' | 'T' ) ( 'p' | 'P' ) ( 's' | 'S' )? '://'
    {
        if ( LA(1) == 'H' || LA(1) == 'h' )
        {
            CONSUME();
...
void mFTP(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:100:19: ( ( 'f' | 'F' ) ( 't' | 'T' ) ( 'p' | 'P' ) '://' )
    // Wikitext.g:100:21: ( 'f' | 'F' ) ( 't' | 'T' ) ( 'p' | 'P' ) '://'
    {
        if ( LA(1) == 'F' || LA(1) == 'f' )
        {
            CONSUME();
...
void mSVN(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:103:19: ( ( 's' | 'S' ) ( 'v' | 'V' ) ( 'n' | 'N' ) '://' )
    // Wikitext.g:103:21: ( 's' | 'S' ) ( 'v' | 'V' ) ( 'n' | 'N' ) '://'
    {
        if ( LA(1) == 'S' || LA(1) == 's' )
        {
            CONSUME();
...
//   Comes from: 106:19: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '@' | '$' | '&' | '\\'' | '(' | '*' | '+' | '=' | '\\%' | '-' | '_' | '~' | '/' | '#' )+ )
/** \brief Lexer rule generated by ANTLR3
 *
...
void mURI_CHARS(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:106:19: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '@' | '$' | '&' | '\\'' | '(' | '*' | '+' | '=' | '\\%' | '-' | '_' | '~' | '/' | '#' )+ )
    // Wikitext.g:106:21: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '@' | '$' | '&' | '\\'' | '(' | '*' | '+' | '=' | '\\%' | '-' | '_' | '~' | '/' | '#' )+
    {
        // Wikitext.g:106:21: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '@' | '$' | '&' | '\\'' | '(' | '*' | '+' | '=' | '\\%' | '-' | '_' | '~' | '/' | '#' )+
        {
            int cnt17=0;
...
void mNAMED_ENTITY(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:134:17: ( '&' ( 'a' .. 'z' | 'A' .. 'Z' )+ ( '0' .. '9' )* ';' )
    // Wikitext.g:134:20: '&' ( 'a' .. 'z' | 'A' .. 'Z' )+ ( '0' .. '9' )* ';'
    {
        MATCHC('&'); 
        if (HASFAILED())
        {
...
//   Comes from: 142:17: ( '&#' ( 'x' | 'X' ) ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+ ';' )
/** \brief Lexer rule generated by ANTLR3
 *
...
void mHEX_ENTITY(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:142:17: ( '&#' ( 'x' | 'X' ) ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+ ';' )
    // Wikitext.g:142:19: '&#' ( 'x' | 'X' ) ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )+ ';'
    {
        MATCHS(lit_13); 
        if (HASFAILED())
        {
...
void mDECIMAL_ENTITY(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:144:17: ( '&#' ( '0' .. '9' )+ ';' )
    // Wikitext.g:144:19: '&#' ( '0' .. '9' )+ ';'
    {
        MATCHS(lit_13); 
        if (HASFAILED())
        {
    ...
    
    {
...

        {
            ...
            else 
            {
                ...
                CONSTRUCTEX();
                EXCEPTION->type         = ANTLR3_NO_VIABLE_ALT_EXCEPTION;
                EXCEPTION->message      = "160:1: CRLF : ( ( ( '\\r' )? '\\n' )=> ( '\\r' )? '\\n' | '\\r' );";
...
void mPRINTABLE(pWikitextLexer ctx)
{
    ...
    // Wikitext.g:167:17: ( '\\u0021' | '\\u0023' .. '\\u0025' | '\\u0027' .. '\\u003B' | '\\u003D' | '\\u003F' .. '\\u005F' | '\\u0061' .. '\\u007B' | '\\u007E' )
    // Wikitext.g:
    {
        if ( LA(1) == '!' || ((LA(1) >= '#') && (LA(1) <= '%')) || ((LA(1) >= '\'') && (LA(1) <= ';')) || LA(1) == '=' || ((LA(1) >= '?') && (LA(1) <= '_')) || ((LA(1) >= 'a') && (LA(1) <= '{')) || LA(1) == '~' )
        {
            CONSUME();
        FAILEDFLAG=ANTLR3_FALSE;
...
{
    {
        //  Wikitext.g:1:39: ( PRE | NO_WIKI_START | NO_WIKI_END | BLOCKQUOTE | STRONG_EM | STRONG | EM | TT_START | TT_END | ESCAPED_TT | TT | OL | UL | H6_START | H5_START | H4_START | H3_START | H2_START | H1_START | H6_END | H5_END | H4_END | H3_END | H2_END | H1_END | URI | LINK_START | LINK_END | EXT_LINK_START | EXT_LINK_END | SEPARATOR | SPACE | QUOT_ENTITY | AMP_ENTITY | NAMED_ENTITY | HEX_ENTITY | DECIMAL_ENTITY | QUOT | AMP | LESS | GREATER | CRLF | PRINTABLE | DEFAULT )
...

        {
            ...
            if ( (LA25_0 == ' ') ) 
            {

                {
                    ...
                    else 
                    {
                        ...
                        CONSTRUCTEX();
                        EXCEPTION->type         = ANTLR3_NO_VIABLE_ALT_EXCEPTION;
                        EXCEPTION->message      = "1:1: Tokens options {k=1; backtrack=true; } : ( PRE | NO_WIKI_START | NO_WIKI_END | BLOCKQUOTE | STRONG_EM | STRONG | EM | TT_START | TT_END | ESCAPED_TT | TT | OL | UL | H6_START | H5_START | H4_START | H3_START | H2_START | H1_START | H6_END | H5_END | H4_END | H3_END | H2_END | H1_END | URI | LINK_START | LINK_END | EXT_LINK_START | EXT_LINK_END | SEPARATOR | SPACE | QUOT_ENTITY | AMP_ENTITY | NAMED_ENTITY | HEX_ENTITY | DECIMAL_ENTITY | QUOT | AMP | LESS | GREATER | CRLF | PRINTABLE | DEFAULT );";
            ...
            else if ( (LA25_0 == '#') ) 
            {
                ...
                {
                    int LA25_6 = LA(2);
                    if ( (( (synpred14(ctx)) && ( COLUMN == 0 || LAST_TOKEN == OL || LAST_TOKEN == UL || LAST_TOKEN == BLOCKQUOTE ) )) ) 
                    {
                        alt25=12;
                    }
                    else if ( (synpred45(ctx)) ) 
            ...
            else if ( (LA25_0 == '*') ) 
            {
                ...
                {
                    int LA25_7 = LA(2);
                    if ( (( (synpred15(ctx)) && ( COLUMN == 0 || LAST_TOKEN == UL || LAST_TOKEN == OL || LAST_TOKEN == BLOCKQUOTE ) )) ) 
                    {
                        alt25=13;
                    }
                    else if ( (synpred45(ctx)) ) 
            ...
            else if ( (LA25_0 == '=') ) 
            {
                ...
                {
                    int LA25_8 = LA(2);
                    if ( (( (synpred16(ctx)) && ( COLUMN == 0 || LAST_TOKEN == BLOCKQUOTE ) )) ) 
                    {
                        alt25=14;
                    }
                    ...
                    else if ( (( (synpred20(ctx)) && ( COLUMN == 0 || LAST_TOKEN == BLOCKQUOTE ) )) ) 
                    {
                        alt25=18;
                    }
                    else if ( (( (synpred21(ctx)) && ( COLUMN == 0 || LAST_TOKEN == BLOCKQUOTE ) )) ) 
                    {
                        alt25=19;
                    }
                    ...
                    else if ( (synpred26(ctx)) ) 
                    {
                        alt25=24;
                    }
                    else if ( (synpred27(ctx)) ) 
                    {
                        alt25=25;
                    }
                    else if ( (synpred45(ctx)) ) 
            ...
            else if ( (LA25_0 == '!' || ((LA25_0 >= '$') && (LA25_0 <= '%')) || ((LA25_0 >= '(') && (LA25_0 <= ')')) || ((LA25_0 >= '+') && (LA25_0 <= ';')) || ((LA25_0 >= '?') && (LA25_0 <= 'E')) || LA25_0 == 'G' || ((LA25_0 >= 'I') && (LA25_0 <= 'R')) || ((LA25_0 >= 'T') && (LA25_0 <= 'Z')) || LA25_0 == '\\' || ((LA25_0 >= '^') && (LA25_0 <= '_')) || ((LA25_0 >= 'a') && (LA25_0 <= 'e')) || LA25_0 == 'g' || ((LA25_0 >= 'i') && (LA25_0 <= 'r')) || ((LA25_0 >= 't') && (LA25_0 <= '{')) || LA25_0 == '~') ) 
            {
    	...
    	case 28:
    	    ...
    	    break;
    	case 29:
    	    // Wikitext.g:1:258: EXT_LINK_START
    	    {
    	        /* 1:258: EXT_LINK_START */
    	        mEXT_LINK_START(ctx ); 
    	        if (HASFAILED())
    	        {
    	            return ;
    	...
    	case 36:
    	    ...
    	    break;
    	case 37:
    	    // Wikitext.g:1:349: DECIMAL_ENTITY
    	    {
    	        /* 1:349: DECIMAL_ENTITY */
    	        mDECIMAL_ENTITY(ctx ); 
    	        if (HASFAILED())
    	        {
    	            return ;
...
{   
    // Wikitext.g:94:51: ( SPECIAL_URI_CHARS URI_CHARS )
    // Wikitext.g:94:52: SPECIAL_URI_CHARS URI_CHARS
    {
        /* 94:52: SPECIAL_URI_CHARS URI_CHARS */
        mSPECIAL_URI_CHARS(ctx ); 
        if (HASFAILED())
        {
            return ;
...
static void synpred44_fragment(pWikitextLexer ctx ) 
{   
    // Wikitext.g:1:386: ( CRLF )
    // Wikitext.g:1:386: CRLF
    {
...
// This is where rules clean up and exit
//
goto rulesynpred44Ex; /* Prevent compiler warnings */
rulesynpred44Ex: ;
...
static void synpred45_fragment(pWikitextLexer ctx ) 
{   
    // Wikitext.g:1:391: ( PRINTABLE )
    // Wikitext.g:1:391: PRINTABLE
    {
...
// This is where rules clean up and exit
//
goto rulesynpred45Ex; /* Prevent compiler warnings */
rulesynpred45Ex: ;
...
static ANTLR3_BOOLEAN synpred44(pWikitextLexer ctx) 
{
    ANTLR3_UINT64   start;
    ANTLR3_BOOLEAN  success;
    ...
    BACKTRACKING++;
    start	= MARK();
    synpred44_fragment(ctx);	    // can never throw exception
    success	= !(FAILEDFLAG);
    REWIND(start);
    BACKTRACKING--;
    FAILEDFLAG	= ANTLR3_FALSE;
...
static ANTLR3_BOOLEAN synpred45(pWikitextLexer ctx) 
{
    ANTLR3_UINT64   start;
    ANTLR3_BOOLEAN  success;
    ...
    BACKTRACKING++;
    start	= MARK();
    synpred45_fragment(ctx);	    // can never throw exception
    success	= !(FAILEDFLAG);
    REWIND(start);
    BACKTRACKING--;
    FAILEDFLAG	= ANTLR3_FALSE;
